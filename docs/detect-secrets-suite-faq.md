...
This documentation is intended for GitHub Enterprise end users. The rest of the documentation in this repository is intended for developers managing the Detect Secrets Stream tool.
